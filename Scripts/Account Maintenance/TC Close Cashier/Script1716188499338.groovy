...
WebUI.click(findTestObject('Object Repository/Menu/Account Maintenance/Close Cashier/Close baru/a_Open Close Cashier'))

WebUI.click(findTestObject('Object Repository/Menu/Account Maintenance/Close Cashier/Close baru/input_OPEN_gvCashierHistctl02imbClose'))
