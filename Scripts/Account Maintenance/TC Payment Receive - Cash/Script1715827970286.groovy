...
TestData ParamDB = findTestData('Data Files/Konek DB_Param')
...
for (int baris = 1; baris <= Datahohendy.getRowNumbers(); baris++)
	...
	if (Datahohendy.getValue('Use', baris) == 'Yes') {
		...
		if (Datahohendy.getValue('Way Of Payment', baris) == 'Auto Debet'){
			WebUI.click(findTestObject('Object Repository/Menu/Account Maintenance/Payment Receive/Way Of Payment/Wop Auto Debet'))
		}
			else {
		...
		WebUI.setText(findTestObject('Object Repository/Menu/Account Maintenance/Payment Receive/input_Agreement No'), ParamDB1.getValue('AGRMNT_NO', baris))
		...
		WebUI.click(findTestObject('Object Repository/Menu/Account Maintenance/Payment Receive/checklist_Temporary Receipt Form'))
		
		WebUI.click(findTestObject('Object Repository/Menu/Account Maintenance/Payment Receive/img_search recipt form'))
				
		WebUI.setText(findTestObject('Object Repository/Menu/Account Maintenance/Payment Receive/input_Receipt Form'), ParamDB.getValue('RECEIPT_FORM_NO', baris))
			
		WebUI.click(findTestObject('Object Repository/Menu/Account Maintenance/Payment Receive/a_SEARCH'))
			
		WebUI.click(findTestObject('Object Repository/Menu/Account Maintenance/Payment Receive/a_Select'))
