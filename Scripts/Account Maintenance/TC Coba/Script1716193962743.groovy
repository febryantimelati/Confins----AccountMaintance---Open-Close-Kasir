...
for (int baris = 1; baris <= Datahohendy.getRowNumbers(); baris++)
	...
	if (Datahohendy.getValue('Use', baris) == 'No') {
		...
		if (Datahohendy.getValue('Use', baris) == 'No')
			...
			if (Datahohendy.getValue('Use', baris) == 'No') {
			WebUI.setText(findTestObject('Object Repository/Menu/Account Maintenance/Payment Receive/input_Receive From'),
				Datahohendy.getValue('Receive From', baris))
	
			WebUI.setText(findTestObject('Object Repository/Menu/Account Maintenance/Payment Receive/input_notes'),
				Datahohendy.getValue('Notes', baris))
			}
			...
			//WebUI.setText(findTestObject('Object Repository/Menu/Account Maintenance/Payment Receive/input_Receive Amount'),  Datahohendy.getValue('Receive Amount', baris))
